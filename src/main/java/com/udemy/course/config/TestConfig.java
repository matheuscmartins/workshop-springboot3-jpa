...
public class TestConfig implements CommandLineRunner { //interface que roda toda vez quando iniciado
    ...
    @Override
    public void run(String... args) throws Exception {    /*todo comando nesse metodo será rodado quando inciado */
        ...
        p1.getCategories().add(cat2); //feita a associação no Product, pois a referencia foi configurada na Classe Product
        p2.getCategories().add(cat1);
        p2.getCategories().add(cat3);
        p3.getCategories().add(cat3);
        p4.getCategories().add(cat3);
        p5.getCategories().add(cat2);
        productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5)); //salva os product com as associações
        ...
        o1.setPayment(payment1); //associou o pedido 1 com o pagamento 1
